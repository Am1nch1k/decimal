...
START_TEST(sub_test_17) {
  ...
  ck_assert(fabs(res_float - dif_float) < 1e+4);
}
END_TEST
...
//   // src2 = 965453154;
//
//   src1.bits[0] = 0b11111111111111111111111111110110; // ERROR !=
//   18446744073709551615.0; src1.bits[1] = 0b11111111111111111111111111111111;
